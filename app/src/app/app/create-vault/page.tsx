...
// Phase 9: vault creation is gated ON-CHAIN (UNDERWRITING_CURATOR_ROLE in
// ProtocolRoles; the VaultFactory enforces it at contract level too).
// The legacy frontend KYC whitelist was removed.
      ...
      <div style={{ backgroundColor: '#FAFAF8', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: '640px', margin: '64px auto', padding: '0 40px' }}>
          <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E4DC', borderRadius: '16px', padding: '48px', textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: '"Playfair Display", Georgia, serif', fontSize: '26px', fontWeight: 700, color: '#1B3A6B', marginBottom: '12px' }}>On-chain Authorization Required</h2>
